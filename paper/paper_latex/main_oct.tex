...
(iii) Substituting the ImageNet-pretrained backbone for an OCT-specific self-supervised foundation (RETFound or OCTCubeM) and re-running the SSM-bottleneck ablation to determine whether the cross-cohort lift composes additively with stronger pretraining.
